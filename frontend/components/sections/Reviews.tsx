...
const REVIEWS = [
  ...
  { name: "Alina Petrova",       role: "Data Analyst @ Beeline",       initials: "AP", color: "from-purple-500 to-purple-700",  stars: 5, text: "I came for the Data Science course and left with 3 freelance clients and a full-time offer. The curriculum is current — we used tools that I see in job descriptions every day.", course: "Data Science" },
  { name: "Daniyar Seilov",      role: "AI Engineer @ Kolesa Group",   initials: "DS", color: "from-yellow-500 to-orange-600",  stars: 5, text: "The AI course is the most comprehensive I've seen outside of a master's degree. But unlike university, everything here is hands-on. We fine-tuned actual LLMs in week 4.", course: "Artificial Intelligence" },
