          ...
          <div className="lg:col-span-2 flex flex-col gap-5">
            <div className="flex items-center gap-3">
              <div className="relative">
                <svg viewBox="0 0 44 44" fill="none" className="w-9 h-9 text-green-400" aria-hidden="true">
                  <path d="M22 3L40 12V30L22 41L4 30V12L22 3Z" stroke="currentColor" strokeWidth="2" strokeLinejoin="round"/>
                  <path d="M22 3V41M4 12L40 30M40 12L4 28" stroke="currentColor" strokeWidth="1.5" strokeOpacity="0.5" strokeLinejoin="round"/>
                  <circle cx="22" cy="22" r="5" fill="currentColor" opacity="0.3"/>
                </svg>
                <div className="absolute inset-0 bg-green-500 blur-xl opacity-20 rounded-full" aria-hidden="true" />
              </div>
